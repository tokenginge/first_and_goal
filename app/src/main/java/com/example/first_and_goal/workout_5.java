...
public class workout_5 extends Fragment implements ImageAdapter.OnMenuItemClickListener {
    ...
    private DocumentReference workoutref = db.collection(user.getEmail()).document("Workouts").collection("number").document("5");
    private static final String KEY_WORK_1 = "Workout 5";
    ...
    private DatabaseReference dbref = db2.getReference(user.getUid()).child("Workout").child("5");
    private DatabaseReference mData = db2.getReference(user.getUid()).child("Workout");

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View RootView = inflater.inflate(R.layout.fragment_workout_5, container, false);
        ...
        mDBListener = dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                imageAdapter.setOnMenuItemClickListener(workout_5.this);
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        msave.setPositiveButton("Save", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                workref.collection("number").document("5").set(note);
                                showSnackbar();
                                chronometer.setBase(SystemClock.elapsedRealtime());
                                pauseoffSet = 0;
                            }
