...
public class DL_drills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_dl_drills);
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference("DL");
        ...
        mDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapt = new DrillItemsAdapter(DL_drills.this, mDrills);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DL_drills.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
