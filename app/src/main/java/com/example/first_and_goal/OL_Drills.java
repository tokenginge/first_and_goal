...
public class OL_Drills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_ol__drills);
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference("OL");
        ...
        mDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapt = new DrillItemsAdapter(OL_Drills.this, mDrills);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(OL_Drills.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
