...
public class QB_Drills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_qb__drills);
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference("QB");
        ...
        mDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapt = new DrillItemsAdapter(QB_Drills.this, mDrills);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(QB_Drills.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
