...
public class LB_Drills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_lb__drills);
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference("LB");
        ...
        mDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapt = new DrillItemsAdapter(LB_Drills.this, mDrills);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(LB_Drills.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
