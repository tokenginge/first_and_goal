...
public class agility_drills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.fragment_agility_drills);
        ...
        mDataRef = FirebaseDatabase.getInstance().getReference("Agility");
        ...
        mDataRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapt = new DrillItemsAdapter(agility_drills.this, mDrills);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(agility_drills.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
